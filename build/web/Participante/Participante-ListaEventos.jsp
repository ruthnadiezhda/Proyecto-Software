<%-- 
    Document   : Participante-ListaEventos
    Created on : 10/11/2019, 05:51:03 PM
    Author     : USER
--%>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h1 mb-2 text-gray-800">Lista de Eventos:</h1>
          <p class="mb-4">Bienvenido Teleco. Estas son los eventos creados para la asignación de Voley.</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-primary">Voley</h4>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>12:00</td>
                      <td>Polideportivo</td>
                      <td>Es la primera convocatoria para elegir nuestros participantes en Voley. Ven y participa! Te esperamos.</td>
                      <td><!-- Default unchecked -->
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="defaultUnchecked1" checked disabled>
    <label class="custom-control-label" for="defaultUnchecked1">Participar</label>
</div></td>
                    </tr>
                    <tr>
                      <td>Primera Práctica</td>
                      <td>28/09/2019</td>
                      <td>15:00</td>
                      <td>Cancha de Minas</td>
                      <td>Es el primer partido de practica para elegir nuestros participantes en Voley. Ven y participa! Te esperamos.</td>
                      <td><!-- Default unchecked -->
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="defaultUnchecked2">
    <label class="custom-control-label" for="defaultUnchecked2">Participar</label>
</div></td>
                    </tr>
                    <tr>
                      ...
                      <td>17:00</td>
                      <td>Cancha de Minas</td>
                      <td>Es la segunda convocatoria de practica para elegir nuestros participantes en Voley. Ven y participa! Te esperamos.</td>
                      <td><!-- Default unchecked -->
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="defaultUnchecked3">
    <label class="custom-control-label" for="defaultUnchecked3">Participar</label>
</div></td>
                    </tr>
                    <tr>
                      <td>Segunda Práctica</td>
                      <td>30/09/2019</td>
                      <td>19:00</td>
                      <td>Polideportivo</td>
                      <td>Es el segundo partido de practica para elegir nuestros participantes en Voley. Ven y participa! Te esperamos.</td>
                      <td><!-- Default unchecked -->
<div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="defaultUnchecked4">
    <label class="custom-control-label" for="defaultUnchecked4">Participar</label>
</div></td>
                    </tr>
            ...
            <div style="margin-left: auto;">
              <a href="#" class="btn bg-primary btn-icon-split">
                    <span class="icon text-light" > <i class="fas fa-arrow-right"></i> </span><span class="text text-light">Guardar Cambios</span></a>
            </div>
          </div>
