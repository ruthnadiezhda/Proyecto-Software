...
<head>
  ...
  <title>Estadisticas - Fibra Toxica 2019</title>
...
<body id="page-top">
 ...
 <!-- Sidebar -->
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="DG-ListaActividades.jsp">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Estadistica</h1>
          <p class="mb-4">Bienvenido Delegado General! En esta pagina podra ver las estadisticas de los eventos, actividades y participantes por la Fibra Toxica en la Semana de Ingenieria 2019.</p>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Recaudación de Donaciones</h6>
                </div>
                <div class="card-body">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Numero de participantes por disciplina</h6>
                </div>
                <div class="card-body">
                  <div class="chart-bar">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Informacion de participantes</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
