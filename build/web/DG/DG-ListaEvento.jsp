...
<head>
  ...
  <title>Lista de Eventos DG</title>
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>13</td>
                      <td>25/04/2019</td>
                      <td> <a href="#" class="btn btn-info btn-circle btn-circle"> <i class="fas fa-edit"></i></i> </a>  <a href="/blank.jsp" class="btn btn-danger btn-circle"> <i class="fas fa-trash"></i></a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>2</td>
                      <td>30/06/2019</td>
                      <td> <a href="#" class="btn btn-info btn-circle btn-circle"> <i class="fas fa-edit"></i> </a>  <a href="/blank.jsp" class="btn btn-danger btn-circle"> <i class="fas fa-trash"></i></a></td>
                    </tr>
...
<div style="margin-left: auto;">
              <a href="#" class="btn bg-danger btn-icon-split">
