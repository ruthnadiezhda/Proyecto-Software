<%-- 
    Document   : Participante-PostularDA
    Created on : 10/11/2019, 05:51:47 PM
    Author     : USER
--%>
...
<head>
  ...
  <title>Postular para Delegado General</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Postular a delegado de actividad</h1>
          <p class="mb-4">Si usted quiere apoyar a la Fibra Tóxica siendo el delegado de actividad relllene los datos solicitados a continuación.</p>
          <hr></hr>
          ...
          <div class="row">
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Razones para postular:</h6>
                </div>
                <textarea type="email" rows="5" class="form-control form-control-user" id="exampleInputEmail" placeholder="Escriba aquí">
                </textarea>              
              </div>
              <a href="Participante-PaginaActividadVoley.jsp" class="btn btn-primary btn-icon-split">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Recuerde que:</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <p>Un delegado de actividad requiere organización, compromiso y energía para entrenar a sus competidores.</p>
                </div>
              </div>
            </div>
          </div>
