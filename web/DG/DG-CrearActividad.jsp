    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Nueva Actividad</h1>
          <hr></hr>
            ...
            <div class="col-xl-10 col-lg-">
              ...
              <div class="card mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Nombre de La Actividad</h6>
                  <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="Nombre de la Actividad" aria-describedby="emailHelp" placeholder="Nombre de la Actividad">
                  </div> 
                  ...
                  <a href="DG-ListaActividades.jsp" class="btn bg-gradient-danger btn-icon-split float-right">
